...
# 3.1 建立 governance/rules/ 人工治理规则层（见目录内 README）
...
[ ] governance/rules/ 的 active Markdown 规则集有 verified human approver、scope、rule_id 和 content_hash
[ ] 普通内容 Workflow 使用 ai_automated review，不进入 waiting_approval
