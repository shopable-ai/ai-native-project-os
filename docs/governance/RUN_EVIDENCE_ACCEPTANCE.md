...
AI 审核裁决的机器字段只由 `policies/ai-review-verdict-contract.yaml` 定义。它必须精确绑定被审核对象/hash、生成 Run、独立审核 Run/节点、reviewer 模型指纹、active 规则集/hash、逐规则结果、finding 和 Evidence。
